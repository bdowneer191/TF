        ...
        <aside className="w-64 bg-slate-900/70 backdrop-blur-lg p-6 border-r border-slate-800 flex-shrink-0 hidden md:flex flex-col">
            ...
            <nav className="flex flex-col gap-2">
                ...
                <button
                    ...
                    className="flex items-center gap-3 px-4 py-2 text-slate-400 hover:text-slate-200 hover:bg-slate-800 rounded-lg transition-colors text-left font-semibold"
                >
            ...
            <div className="mt-auto bg-slate-800/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-slate-400 mt-1">Unlock advanced features and higher usage limits.</p>
